...
namespace Acme\Bundle\CurrencyExchangeRate\DependencyInjection;
...
final class AcmeCurrencyExchangeRateExtension extends Extension implements PrependExtensionInterface
{
    /**
